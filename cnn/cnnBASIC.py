...
def run_network_new(fixed_weights,kernel_size,total_hid, training, y, validation, val_y, batch_size=50, nb_epoch=30):
...
#                   'kullback_leibler_divergence'
    ...
    plot_model(model, to_file='cnnBASIC.png')
...
#for i in range(10):
    ...
    start = time.time()
    model, history = run_network_new(fixed_weights,kernel_size,seq_hid, seq_train, y, validation = seq_validation, val_y = val_y, 
